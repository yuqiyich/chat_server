...
public interface DotEventInfoWrapper {
    ...
    @Select({"<script>",
            ...
            "</script>"})
    long queryEventTotalOrderSize(RecordInfo<DotEventInfo> dotEventInfo, String eventType);
    ...
    @Select({"<script>",
            ...
            "</script>"})
    long queryEventTotalUserSize(RecordInfo<DotEventInfo> dotEventInfo, String eventType);
}
