...
public class UrlConstant {
    ...
    public class WeChatUrl {
        // 用户
        // 获取用户的token和openId
        public final static String USER_AUTHORIZE ="https://open.weixin.qq.com/connect/oauth2/authorize?appid=%s&redirect_uri=%s&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect";
        // 拉取用户信息(需scope为 snsapi_userinfo)
        public final static String USER_INFO_GET ="https://api.weixin.qq.com/sns/userinfo?access_token=%s&openid=%s&lang=zh_CN";
