...
public class SendMsgController {
	...
	// @ResponseBody
    public String sendMsg(String type) {
		DefaultProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAI4FjDehvg62XM5XNX11zD", "HgTQAK0SKh85mgAb8C6ui3AjCZ3lxq");
        ...
        request.putQueryParameter("TemplateCode", "SMS_183798722");
